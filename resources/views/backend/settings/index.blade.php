...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default"
      data-assets-path="public/backend/assets/" data-template="vertical-menu-template-free">
<head>
    <meta charset="utf-8"/>
    <meta
            name="viewport"
    ...
    <link rel="stylesheet" href="public/backend/assets/vendor/css/theme-default.css"
          class="template-customizer-theme-css"/>
    <link rel="stylesheet" href="public/backend/assets/css/demo.css"/>

    <link rel="stylesheet"
          href="public/backend/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css"/>
                                ...
                                <div class="card shadow rounded mb-4">
                                    ...
                                    <form method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @if ($user->avatar)
                                                    <div class="mt-2">
                                                        <img src="{{ asset('storage/' . $user->avatar) }}" alt="Avatar" width="80" class="rounded-circle">
                                                    </div>
                                                @endif
                                            </div>
                                ...
                                <div class="card shadow rounded">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('settings.password.update') }}">
                                            ...
                                            <a href="{{ route('dashboard.layout') }}" class="btn btn-secondary w-100 mt-2"> Quay lại</a>
...
<script
        src="public/backend/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
