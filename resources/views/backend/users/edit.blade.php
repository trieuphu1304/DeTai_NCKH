<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Trang chủ/</span> Cập nhật tài khoản</h4>
                        ...
                        <form method="POST" action="{{ route('users.update', $users ->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input name="password" type="password" class="form-control"
                                        value="{{$users ->password}}" id="password" placeholder="Mật khẩu" required>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="roles_id" class="form-select" id="roles_id">
                                    <option value="1" {{ $users->roles_id == 1 ? 'selected' : '' }}>Quản lý</option>
                                    <option value="0" {{ $users->roles_id == 0 ? 'selected' : '' }}>Khách hàng</option>
                                </select>
                            </div>  
