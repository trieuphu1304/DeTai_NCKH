              ...
              <li class="nav-item submenu dropdown">
                  ...
                  <style>
                    ...
                    .dropdown-menu {
                        ...
                        padding: 10px 20px; /* Thêm padding để các mục không bị sát nhau */
                        min-width: 135px; /* Đảm bảo dropdown đủ rộng */
                    }
                    ...
                    .dropdown-menu .nav-link {
                        color: #333; /* Màu chữ xám tối */
                        font-size: 16px; /* Kích thước chữ phù hợp */
                        text-decoration: none; /* Loại bỏ gạch chân */
                        display: block; /* Đảm bảo mục chiếm toàn bộ chiều rộng */
                        padding: 8px 0; /* Padding cho các mục */
                        border-radius: 6px; /* Bo tròn góc các mục */
                    ...
                    .dropdown-menu .nav-link:active {
                        background-color: #0056b3; /* Màu nền khi focus hoặc active */
                        color: #fff; /* Màu chữ khi focus hoặc active */
                    }
