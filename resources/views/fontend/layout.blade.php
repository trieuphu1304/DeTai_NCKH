...
<head>
    ...
    <style>
        #chat-box {
            ...
            /* Hiển thị tin nhắn từ trên xuống */
            scrollbar-width: thin;
            /* Cho scrollbar mỏng hơn */
            scrollbar-color: #aab5be #cfd8dc;
            /* Màu cho scrollbar */
        }
        ...
        .message.sent {
            ...
            /* Màu nền tin nhắn gửi đi */
            color: #1a237e;
            /* Màu chữ tin nhắn gửi đi */
            align-self: flex-end;
            /* Căn phải tin nhắn gửi đi */
        ...
        .message.received {
            ...
            /* Màu nền tin nhắn nhận được */
            color: #212121;
            /* Màu chữ tin nhắn nhận được */
            align-self: flex-start;
            /* Căn trái tin nhắn nhận được */
...
<img id="chat-toggle-logo" src="{{ asset('/fontend/img/chat_logo.png') }}"
    style="position: fixed; bottom: 20px; right: 20px; width: 60px; height: 60px; cursor: pointer; z-index: 1000;"
    onclick="toggleChat()">

<div id="chat-wrapper"
    style="position: fixed; bottom: 90px; right: 20px; width: 300px; height: 400px; background: #fff; border: 1px solid #ccc; border-radius: 8px; display: none; z-index: 1000; box-shadow: 0 0 10px rgba(0,0,0,0.2); overflow: hidden;">
    <div id="chat-header" onclick="toggleChat()"
        style="background: #384aeb; color: white; padding: 10px; text-align: center; font-weight: bold; cursor: pointer;">
